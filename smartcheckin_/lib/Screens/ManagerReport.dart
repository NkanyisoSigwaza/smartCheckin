...
import 'package:smartcheckin_/Shared/UserDrawer.dart';
        ...
        Padding(
          ...
          child: FlatButton(
              ...
              onPressed: (){
                Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context)=> ManagerAnnouncements())
                );
              },
              child: Text(
                "Announcement",
                  ...
                  Padding(
                    ...
                    child: FlatButton(
                        ...
                        onPressed: (){
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context)=> ManagerCustomReport())
                          );
                        },
                        child: Text(
                          "Custom report",
